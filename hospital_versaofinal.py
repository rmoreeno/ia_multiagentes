...
import sys #ambiente de execução
import threading #permite lidar com threads
import time #p manipular operações c/ tempo
import random #p gerar numeros aleatorios com python
